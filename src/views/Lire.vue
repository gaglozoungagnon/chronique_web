<template>
    <div class="bg-gray-900 px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
        <div class="mx-auto max-w-2xl gap-x-8  gap-y-16 lg:mx-0 lg:max-w-none">
            <div
...
<style scoped>.custom-background {
