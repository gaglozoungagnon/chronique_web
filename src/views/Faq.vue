<template class="">
  <div class="bg-white h-full">
    ...
    <div class="text-center h-full ml-44 mr-44">
      <div class="flex mt-4">
        <h1 class="font-bold text-2xl text-gray-700 mt-2 text-left">
        ...
        <svg
          ...
          stroke-width="1.5"
          stroke="currentColor"
          class="w-9 h-9 ml-4 mt-1 cursor-pointer"
      ...
      <p v-if="showParagraph" class="text-base text-gray-700 mt-4 text-left">
      ...
      <h1 class="font-bold text-2xl text-gray-700 mt-2 text-left">
        Q5 : Comment puis-je participer à des concours littéraires sur Top
        Chronique ?
      </h1>
      <p class="text-base text-gray-700 mt-4 text-left">
