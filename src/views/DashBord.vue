<template>
  ...
  >
    ...
    <div class="flex">
        ...
        <div class="bg-gray-800 h-52 rounded-lg">
          ...
          <div class="flex">
            <img
              ...
              alt=""
            />
            <p class="text-white mt-12 text-lg font-bold ml-4">Le tritre</p>
          </div>
        </div>
        <div class="bg-gray-800 h-24 mt-4 rounded-lg">
          <div class="flex">
            <div class="">
              <div class="flex ml-32 text-white w-24">
                <p class="text-white mt-6 text-lg font-bold ml-4">0</p>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <p class="text-white ml-24">Fans</p>
            </div>
            <div class="">
              <div class="flex ml-24 text-white w-24">
                <p class="text-white mt-6 text-lg font-bold ml-4">0</p>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              <p class="text-white ml-16">Avis sur l'histoire</p>
            </div>
            <div class="">
              <div class="flex ml-36 text-white w-24">
                <p class="text-white mt-6 text-lg font-bold ml-4">0</p>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              <p class="text-white ml-32">(0 note)</p>
            </div>
          </div>
        </div>
        <div class="flex">
            ...
            <div class="flex">
              <div class="">
                <div class="flex ml-24 text-white w-24">
                  ...
                  <p class="text-white ml-2 mt-6">Lecteurs actifs</p>
                </div>
              </div>
              <div class="ml-32">
                <p class="text-white mr-9 mt-9 text-xl">0</p>
              </div>
            </div>
          </div>
          <div class="bg-gray-800 h-24 ml-24 mt-4 rounded-lg">
            <div class="flex">
              <div class="">
                <div class="flex ml-24 text-white w-24">
                  <svg
      ...
      <div class="w-1/3">
      <div class="bg-gray-800 h-32  rounded-lg ">
          <div class="flex">
            <div class="">
              <div class="flex ml-24 text-white w-24">
                <p class="text-white mt-6 text-lg font-bold ml-4">0</p>
         ...
         <div class="bg-gray-800 h-32 mt-2 rounded-lg ">
          <div class="flex">
            <div class="">
              <div class="flex ml-24 text-white w-24">
                <p class="text-white mt-6 text-lg font-bold ml-4">0</p>
