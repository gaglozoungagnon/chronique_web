    ...
    <div class="flex">
        ...
        <div class="shadow-sm border border-gray-200 h-52 rounded-lg">
          ...
          <div class="flex">
            <img
              ...
              alt=""
            />
            <p class="mt-12 text-lg font-bold ml-4">Le tritre</p>
          </div>
        </div>
        <div class="shadow-sm border border-gray-200 h-24 mt-4 rounded-lg">
          <div class="flex">
            <div class="">
              <div class="flex ml-32 w-24">
              ...
              <p class="ml-24">Fans</p>
            </div>
            <div class="">
              <div class="flex ml-24 w-24">
                <p class="mt-6 text-lg font-bold ml-4">0</p>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <p class="ml-16">Avis sur l'histoire</p>
            </div>
            <div class="">
              <div class="flex ml-36 w-24">
                <p class="mt-6 text-lg font-bold ml-4">0</p>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
      ...
      <div class="w-1/3">
        ...
        <div class="h-12 mt-2 shadow-sm border border-gray-200 rounded-lg flex items-center">
            ...
            <div class="ml-2">
              <p class=" whitespace-nowrap">Nombre de lecture unique</p>
            </div>
            <div class="ml-auto mr-12">
              <p class="">0</p>
            </div>
        ...
        <div
          class="h-12 mt-2 shadow-sm border border-gray-200 rounded-lg flex items-center"
        >
          <div class="ml-2">
            <p class="whitespace-nowrap">Nombre de réaction</p>
          </div>
          <div class="ml-auto mr-12">
            <p class="">0</p>
          </div>
    ...
    <div class="shadow-sm border border-gray-200 h-24 mt-4 rounded-lg">
      <div class="flex">
        <div class="">
          ...
          <p class="ml-24">Nombre de lecture</p>
        </div>
        <div class="">
          <div class="flex ml-24 w-24">
            <p class="mt-6 text-lg font-bold ml-4">0</p>
        ...
        <div class="">
          ...
          <p class="ml-16">Nombre de réaction</p>
        </div>
        <div class="">
          <div class="flex ml-24 w-24">
            <p class="mt-6 text-lg font-bold ml-4">0</p>
          ...
          <p class="ml-16">Date de publication</p>
        </div>
      </div>
    </div>
  </div>
