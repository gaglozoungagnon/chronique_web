<template>
    <footer class="bg-gray-800 text-white h-36">
      <div class="ml-80">
        <div class="flex flex-col md:flex-row ">
          ...
          <div class="md:w-1/3  mt-4">
            ...
            <ul class="flex space-x-4 ml-24 mt-1">
            ...
            <p>C.G.U Confidentialité FAQ Apropos </p>
            <p>Top chronique @2023 Tous droits reservès</p>
          </div>
        </div>
      </div>
    </footer>
